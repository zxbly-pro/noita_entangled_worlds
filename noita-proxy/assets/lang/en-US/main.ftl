...
game_mode_PvP = PvP
Local-health-pvp = Local health PvP
round-based-pvp-mode = Round-based PvP mode
pvp-money-steal-percent = % money stolen on kill
pvp-dont-steal = Just gain money instead of stealing
pvp-spawn-chest-on-win = Spawn chest on win
pvp-timed-rounds-hm = Timed rounds/HM
pvp-wait-on-time = Wait on time to finish round
pvp-time-in-hm = Time in HM
pvp-time-in-round = Time in round
pvp-wait-on-players = Wait on players to finish round to start next round
world-generation = World generation
duplicate-synced-entities = Duplicate synced entities
fix-unseen-chunks = Fix blackholes/explosions in unseen chunks
disable-kummitus-non-hosts = Disable kummitus on non-hosts
give-host-sampo-on-collection = Give host sampo on collection
spell-ban-list-desc = Spell ban list, by internal names, comma separated
player-settings = Player settings
Share-Gold = Share Gold
Perks = Perks
perk-ban-list-desc = Perk ban list, by internal names, comma separated
global-perks-ignore-desc = Globals to ignore, by internal names, comma separated. May cause undefined behavior; do not report issues. See perk_fns.lua
audio-dropoff-rate = Drop-off rate of audio from others
audio-max-range = Maximal range of audio
audio-global-input-volume = Global input volume
audio-global-output-volume = Global output volume
audio-loopback = Loopback audio
audio-global-playback = Always play voice globally
audio-push-to-talk = Push to talk; keybinds in Noita, T by default
audio-use-player-position = Use player position rather than camera position
audio-mute-input = Mute input
audio-mute-input-polied = Mute input while polied
audio-mute-input-dead = Mute input while dead
audio-mute-output = Mute output
audio-disabled = Disabled
audio-input-device-label = Input Device
audio-output-device-label = Output Device
Show-host-settings = Show host settings
Show-audio-settings = Show audio settings
Close-Proxy = Close Proxy
Failed-to-request-lobby-list = Failed to request lobby list
reset-all-data = Reset all data
Allow-friends = Allow friends
nickname = Nickname
Lobby = Lobby
...
Mod-List = Mod List
Back-out = Back out
Netmanager-stopped = Netmanager thread has stopped
With-error = With the following error:
No-lobby-created-yet = No lobby created yet
save-colors = Save colors
requires-noita-restart = Requires noita restart
dont-let-more-players-join = Don't let more players join
dont-send-chunk-map-to-players = Don't send chunk map to players
dont-save-chunk-map-desc = Don't save chunk map; chunk map is disabled by default due to current implementation leaking RAM/VRAM on long runs
no-conn-info-tangled = No connection info available in tangled mode
save-to-clipboard = Save to clipboard
Pending-settings-note = Pending settings; not set until run ends
